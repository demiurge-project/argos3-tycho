 ...
 *
 * The controller performs aggregation task including obstacle avoidance
 *
 * This controller is meant to be used with the XML files:
 *    testing/real_time_experiment.argos
 */

#ifndef GROUND_SENSOR_PROTOTYPE_CONTROLLER_H
#define GROUND_SENSOR_PROTOTYPE_CONTROLLER_H
 ...
 */
class CGroundSensorPrototypeController : public CCI_Controller {

public:

   /* Class constructor. */
   CGroundSensorPrototypeController();

   /* Class destructor. */
   virtual ~CGroundSensorPrototypeController() {}
