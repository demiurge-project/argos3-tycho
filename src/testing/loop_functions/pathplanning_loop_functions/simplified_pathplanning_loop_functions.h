#ifndef SIMPLIFIED_PATH_PLANNING_LOOP_FUNCTIONS_H
#define SIMPLIFIED_PATH_PLANNING_LOOP_FUNCTIONS_H
...
class CSimplifiedPathPlanningLoopFunctions : public CLoopFunctions {
public:

   CSimplifiedPathPlanningLoopFunctions();
   virtual ~CSimplifiedPathPlanningLoopFunctions() {}
