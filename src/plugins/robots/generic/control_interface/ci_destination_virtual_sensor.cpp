/**
 * @file <argos3/plugins/robots/generic/control_interface/ci_destination_virtual_sensor.cpp>
 *
 * @author Bernard Mayeur <bmayeur@gmail.com>
 */

#include "ci_destination_virtual_sensor.h"
...
/*
   ...
   void CCI_DestinationVirtualSensor::CreateLuaState(lua_State* pt_lua_state) {
...
*/
   ...
   /****************************************/
/*
   void CCI_DestinationVirtualSensor::ReadingsToLuaState(lua_State* pt_lua_state) {
