/**
 * @file <argos3/plugins/robots/generic/real_robot/real_virtual_radiation_sensor.h>
 *
 * @author Andreagiovanni Reina <areina@ulb.ac.be>
 */

#ifndef REAL_VIRTUAL_RADIATION_SENSOR_H
#define REAL_VIRTUAL_RADIATION_SENSOR_H

namespace argos {
   class CRealVirtualRadiationSensor;
...
namespace argos {
   ...
   class CRealVirtualRadiationSensor: public CCI_VirtualRadiationSensor, public CRealVirtualSensor
   {
